...
All exception paths invoke the Exception Handling Form to present messages/actions and record entries where appropriate. See ../MVVM Definitions/ExceptionHandling.md.
